...
class AccountMoveReversal(models.TransientModel):
    ...
    #             raise ValidationError("No puede reversar mayor cantidad de la que hay en el balance del documento afectado")
    ...
    @api.depends('is_invoice')
    # @api.depends('is_invoice', 'product_balance_ids.quantity', 'product_balance_ids.origin_available_quantity')
    def _compute_fully_reverse_invoice(self):
        for wizard in self:
            wizard.fully_reverse_invoice = wizard.is_invoice and False
    ...
    #     if is_modify:
    #         raise UserError("No se soporta is_modify")
